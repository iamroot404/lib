                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="issue_books.php"><i class="fa fa-book"></i> issue Books <span class="fa fa-chevron-down"></span></a>
                                 </li>
                            ...
                            <li><a href="books_with_students.php"><i class="fa fa-bar-chart-o"></i> Books Infomation <span
                                    class="fa fa-chevron-down"></span></a>
