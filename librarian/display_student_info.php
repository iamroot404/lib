                            ...
                            <div class="x_content">
                                <?php
                                    ...
                                    echo "<td>"; echo $row["status"]; echo "</td>";
                                     echo "<td>"; ?> <a href="notapprove.php?id=<?php echo $row["id"];?>">Block</a><?php echo "</td>";
                                    echo "<td>"; ?> <a href="approve.php?id=<?php echo $row["id"];?>">Unblock</a><?php echo "</td>";
